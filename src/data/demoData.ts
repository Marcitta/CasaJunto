...
export const demoFamilyTasks: FamilyTask[] = [
  { id: 'ft-1', family_id: 'fam-silva-01', task_master_id: 'kitch-1', frequency: 'daily', preferred_days: [0,1,2,3,4,5,6], preferred_time: '13:00', active: true, assigned_automatically: true },
  { id: 'ft-2', family_id: 'fam-silva-01', task_master_id: 'clean-1', frequency: 'daily', preferred_days: [0,1,2,3,4,5,6], preferred_time: '16:30', active: true, assigned_automatically: true },
  { id: 'ft-3', family_id: 'fam-silva-01', task_master_id: 'laund-5', frequency: 'daily', preferred_days: [0,1,2,3,4,5,6], preferred_time: '18:00', active: true, assigned_automatically: true },
  { id: 'ft-4', family_id: 'fam-silva-01', task_master_id: 'waste-1', frequency: 'daily', preferred_days: [0,1,2,3,4,5,6], preferred_time: '20:00', active: true, assigned_automatically: true },
  ...
  { id: 'ft-7', family_id: 'fam-silva-01', task_master_id: 'kitch-2', frequency: 'daily', preferred_days: [0,1,2,3,4,5,6], preferred_time: '20:30', active: true, assigned_automatically: true },
  { id: 'ft-8', family_id: 'fam-silva-01', task_master_id: 'org-1', frequency: 'daily', preferred_days: [0,1,2,3,4,5,6], preferred_time: '07:45', active: true, assigned_automatically: true },
  { id: 'ft-9', family_id: 'fam-silva-01', task_master_id: 'clean-3', frequency: 'several_times_week', preferred_days: [1,3,5], preferred_time: '17:00', active: true, assigned_automatically: true },
  { id: 'ft-10', family_id: 'fam-silva-01', task_master_id: 'waste-2', frequency: 'several_times_week', preferred_days: [2,4,6], preferred_time: '19:00', active: true, assigned_automatically: true },
  { id: 'ft-11', family_id: 'fam-silva-01', task_master_id: 'out-2', frequency: 'several_times_week', preferred_days: [1,4,6], preferred_time: '09:00', active: true, assigned_automatically: true },
  { id: 'ft-12', family_id: 'fam-silva-01', task_master_id: 'bath-4', frequency: 'weekly', preferred_days: [6], preferred_time: '10:00', active: true, assigned_automatically: true },
  { id: 'ft-13', family_id: 'fam-silva-01', task_master_id: 'laund-1', frequency: 'several_times_week', preferred_days: [1,3,5], preferred_time: '08:30', active: true, assigned_automatically: true },
  { id: 'ft-14', family_id: 'fam-silva-01', task_master_id: 'pet-1', frequency: 'daily', preferred_days: [0,1,2,3,4,5,6], preferred_time: '08:00', active: true, assigned_automatically: true }
];
